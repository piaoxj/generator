 ...
 * @mobile 15901283289
 */
public class ${channelClass}_RefCallBackMsgHandler extends FreemarkChannelMsgHandlerImpl<CallBackReqDTO, CallBackRepDTO> {

    private static final Logger logger = LoggerFactory.getLogger(${channelClass}_RefCallBackMsgHandler.class);
